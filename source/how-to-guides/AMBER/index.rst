...
.. note::
    ...
    Farklı parametreler (optimizasyon parametresi vb. gibi) ile kuruluma ihtiyaç söz konusu ise ilgili programın kullanıcı el kitabından bilgialınabilir. SLURM betik dosyası benzer doğrultuda optimizason parametrelerini içerecek şekilde yapılandırılabilir.
